...
/*
 *
 * FILE : MPC5534_HWInit.h
 *
 * DESCRIPTION:
 *  This file contains all MPC5534 derivative needed initializations, 
 *  and all initializations for the MPC5534 boards which are supported.
...
#ifndef _MPC5534_HWINIT_H_
#define _MPC5534_HWINIT_H_
